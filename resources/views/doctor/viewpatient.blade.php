                                            ...
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="input-group date" id="data_1">
                                                        <?php
                                                        $medicalHistory=\App\MedicalHistory::orderBy('id','desc')->first();



                                                        ?>
                                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="followUp" value="{{$medicalHistory->followUpDate}}" id="datepicker">
                                                    </td>

                                                    <td class="client-status"><button id="save" class="btn btn-primary  btn-xs">Save</button></td>
                                    ...
                                    <div class="client-detail">
                                        <div class="full-height-scroll">
                                            ...
                                            <ul class="list-group clear-list">
                                                ...
                                                <li class="list-group-item">
                                                    <span class="pull-right"> {{$patient->email}} </span>
                                                    Email
                                                </li>
                                            </ul>
