                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="client-status"><button id="edit" class="btn btn-primary btn-xs m-l-sm" onclick="edit()" type="button">Edit</button>
                            <button id="save" class="btn btn-primary  btn-xs" onclick="save()" type="button">Delete</button></td>
                                                </tr>
                                                <tr>
                            ...
                            <button id="save" class="btn btn-primary  btn-xs" onclick="save()" type="button">Delete</button></td>
                                                ...
                                                <tr>
                                                    <td class="client-avatar"><img alt="image" src="{{asset('back/img/a5.jpg')}}"> </td>
