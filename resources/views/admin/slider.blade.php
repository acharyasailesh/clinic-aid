...
@section('slider')
        ...
        @if(Session::has('success'))
            <div class="alert alert-success" role="alert">
                ...
                You can view Slider on <a href="{{url('/')}}">Slider</a>
            </div>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content no-padding">
                    {!! Form::open(array('route' => 'image.slider','enctype' => 'multipart/form-data')) !!}
                    ...
                    <div class="form-group">
                        <br>
                        {!!  Form::label('title', 'Slider Title', array('class' => 'col-sm-2 control-label'))!!}
                        <br>
                        <div class="row">
